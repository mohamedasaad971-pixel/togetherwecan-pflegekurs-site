...
// (?=[\s/>]) لا "\b": حرفٌ غيرُ كلمةٍ كـ"-" يكفي وحده لتحقيق حدّ كلمةٍ، فكان
// "<meta\b" يطابق أيضاً اسمَ عنصرٍ مخصَّصٍ حقيقيٍّ كـ"<meta-widget>" (لا
// علاقة له بتوجيه robots)، فيُفشل الفحصَ خطأً (ملاحظة Codex). الاستباقُ هنا
// يشترط تحديداً أن يلي اسمَ الوسم "meta" مسافةٌ أو "/" أو ">" — نهايةُ اسم
// الوسم الفعليّة بمعيار HTML5 — لا أيّ حرفٍ غيرِ كلمةٍ.
