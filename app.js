...
(function () {
  ...
  function kopfZeile(e, intern) {
    ...
    /* الإنجليزيّةُ حالةٌ ثالثةٌ مستقلّةٌ عن المراجعتين: حتّى مادّةٌ معتمدةٌ
       سريريّاً قد تكون ترجمتُها مسوّدة، والمتعلّمُ يُقال له ذلك بلغته. */
  ...
  function kartenSeite(intern, nurId) {
    ...
    if (!alle.length) {
      h += ui('<div class="band warn">لا مفردةَ واحدة هنا.') +
        ...
        ui("وبناءُ المتعلّم لا يدخله إلّا ما اعتُمد سريريّاً. جرّب ") +
