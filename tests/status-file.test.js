...
// عبارةُ الادّعاء بصيغتَي الفعل والصفة مذكّرةً ومؤنّثة ("معتمد"/"معتمدة"/
// "اعتُمد"/"اعتُمدت")، بعد حذف التشكيل وطيّ المسافات (بما فيها فواصل
// الأسطر) إلى مسافةٍ واحدة. [ةت] لا [ة] وحدها: الصفةُ المؤنّثة تنتهي بتاءٍ
// مربوطةٍ ("معتمدة")، لكنّ الفعلَ الماضي المبنيّ للمجهول المؤنّث ينتهي بتاءٍ
// متحرّكةٍ ("اعتُمدت") — إغفالها كان يُفلت هذه الصيغةَ من المطابقة.
const CLAIM_PATTERNS = [
  /(?:ا|م)عتمد[ةت]?\s+سريريا/,
  /(?:ا|م)عتمد[ةت]?\s+طبيا/,
  "clinically approved",
  "medically approved",
